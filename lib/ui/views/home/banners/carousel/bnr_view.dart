import 'package:bumaco_aios/ui/views/home/banners/carousel/banner_carousel.dart';
import 'package:flutter/material.dart';
import 'package:bumaco_aios/app_core/models/models.dart';

class BNRView extends StatefulWidget {
  BNRView({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _BNRViewState createState() => _BNRViewState();
}

class _BNRViewState extends State<BNRView> {
  @override
...
class BannerImages {
  ...
  static List<BannerModel> listBanners = [
    BannerModel(image: banner1, id: "1"),
    BannerModel(image: banner2, id: "2"),
    BannerModel(image: banner3, id: "3"),
    BannerModel(image: banner4, id: "4"),
  ];
}
