...
List<ProductMakeupModel> productModelFromJson(String str) => List<ProductMakeupModel>.from(json.decode(str).map((x) => ProductMakeupModel.fromJson(x)));

String productModelToJson(List<ProductMakeupModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProductMakeupModel {
    ProductMakeupModel({
        this.id,
        this.brand,
        this.name,
    ...
    factory ProductMakeupModel.fromJson(Map<String, dynamic> json) => ProductMakeupModel(
        id: json["id"],
